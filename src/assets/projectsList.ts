...
export const projects: Project[] = [
  {
    id: `9e617cca-105a-4af4-b8c5-79cb459d3989`,
    title: 'Expression Evaluator',
    description:
      'A calculator that takes in a string as an input and shows the calculation after evaluation. Helps solve complex mathematical equations.',
...
`,
    ...
    skillId: [
      ...
      `94f58d17-5fd2-4ccd-97c9-82fd9b8dad5c`,
    ],
  },
  {
    id: `b455fc16-9fed-48a7-8549-139f3f958301`,
    title: 'B2B marketplace',
    description:
      'A full-stack web app designed for vendors to list their products for businesses. App hosted on EC2.',
    image: 'https://images.unsplash.com/photo-1467232004584-a241de8bcf5d',
    detail_description: `
# B2B Marketplace
...
`,
    ...
    featured: true,
    skillId: [
      `ba70488d-925f-43d0-a003-ac7cfa449c2d`,
      `0f2b17c2-fa5c-42ea-befd-2fb31245f4be`,
      `e359cb47-affe-4e50-a27a-cdcc75742adf`,
      `c1d2ff14-ce24-40b8-8f36-136f83109cdf`,
      `c29e1aa2-960d-4c9f-817e-b1081f8061ff`,
      `83f0e84e-6a9f-4c99-ad0d-cd5aaf675b89`,
      `e2f28b58-8435-46ed-994b-2733c43d26fe`,
      `99791e75-2579-458d-bac8-85041173e5bc`,
      `a902192a-ac61-4b64-bbdd-c0e352d3434d`,
      `f48b5d38-e9a3-4fe8-93f1-8ff2716520c9`,
      `0fd99ade-e146-4ce5-8b13-7ec3713683fd`,
      `a6f96db8-1a98-4e2f-80d7-6b4a81823613`,
    ],
  },
  {
    id: `8d8a3c9b-13a7-4e6c-8ff4-604c8660b391`,
    title: 'Employee Timesheet Tracker',
    description:
      "A full-stack website built to demonstrate CRUD operations through API calls. Helps the users to track the employees' time sheets and activities. ",
    image: 'https://images.unsplash.com/photo-1467232004584-a241de8bcf5d',
    detail_description: `
...
`,
    ...
    featured: false,
    skillId: [
      `78b72b27-a65b-4a86-9ef5-13f081beefd1`,
      `48f6fd98-862d-4287-be5b-5b62a37ae47f`,
      `0982a0ad-ac8d-437b-97d0-e2ff708603f7`,
      `c169bcbb-db33-4507-873e-54aad752b4b3`,
      `0922cb9d-641a-4b0a-bc0a-3b6e298ef468`,
      `beb936e8-a966-48ae-9839-7b924c47bc83`,
    ],
  },
  {
    id: `8195daa1-cce7-4358-b98b-2ee1ed8038ac`,
    title: 'E-commerce Platform',
    description:
      'A full-stack application built with code first approach that utilizes SQL Server database on Azure. A template application that helps the users to start an online shop with minimal edit.',
    image: 'https://images.unsplash.com/photo-1467232004584-a241de8bcf5d',
    detail_description: `
# E-commerce Platform
...
`,
    ...
    skillId: [
      ...
      `0982a0ad-ac8d-437b-97d0-e2ff708603f7`,
      `c169bcbb-db33-4507-873e-54aad752b4b3`,
      `46b92a2f-3adb-41e2-96a9-1ea1621361f4`,
      `0922cb9d-641a-4b0a-bc0a-3b6e298ef468`,
      `5840eab3-214f-4f9f-9ebe-0ccec705e868`,
      `037469d9-1a7f-4237-8d98-feb5cd74afd1`,
      `83f0e84e-6a9f-4c99-ad0d-cd5aaf675b89`,
    ],
  },
  {
    id: `8ad71708-ff29-426f-9299-e6ea8f1c4208`,
    title: 'Playd',
    description:
      'A social network platform designed for music enthusiasts, allowing users to track, review, and share their music experiences. ',
    image: 'https://images.unsplash.com/photo-1467232004584-a241de8bcf5d',
    detail_description: `
# Playd
...
`,
    ...
    skillId: [
      ...
      `b8046640-9316-4ad8-953c-ccb991a7c857`,
      `19c6bbe1-0bab-4c59-8e74-99ea589bb70e`,
      `83f0e84e-6a9f-4c99-ad0d-cd5aaf675b89`,
      `bfa83932-06d7-4b0f-a877-324bc7e3cd43`,
      `9aae535f-712f-4952-96ac-90b340172ae9`,
    ],
  },
  {
    id: `decf78bf-80d8-432c-9d3f-ff9c9211549f`,
    title: 'Home Server - Proxmox',
    description:
      'A home server created to make use of the LAN and the extra storage to facilitate NAS and other fun things.',
    image: 'https://images.unsplash.com/photo-1467232004584-a241de8bcf5d',
    detail_description: `
# Home Server - Proxmox
...
`,
    ...
    skillId: [
      ...
      `484d4691-6b2b-4f9b-8db9-3df0e169fa24`,
      `e7ec7094-0a6a-4ac0-828c-0ae9567556ce`,
      `59755785-af21-4de9-ad21-8c91501374b0`,
    ],
  },
  {
    id: `153fb770-3090-46e0-9080-5365d0d0f279`,
    title: 'Travel Advisory App',
    description:
      'A full-stack web application developed to check for travel conditions and advisories based on the target destinations.',
    image: 'https://images.unsplash.com/photo-1467232004584-a241de8bcf5d',
    detail_description: `
# Travel Advisory App
...
`,
    ...
    skillId: [
      ...
      `b8046640-9316-4ad8-953c-ccb991a7c857`,
      `a6f96db8-1a98-4e2f-80d7-6b4a81823613`,
      `643aef0a-c5b1-4828-9948-3d49ce23e334`,
      `83f0e84e-6a9f-4c99-ad0d-cd5aaf675b89`,
      `5a6481bb-ba20-4aa7-a1d1-ff078158d311`,
      `9aae535f-712f-4952-96ac-90b340172ae9`,
      `19c6bbe1-0bab-4c59-8e74-99ea589bb70e`,
      `99791e75-2579-458d-bac8-85041173e5bc`,
    ],
  ...
  {
    id: `4ece98ca-5bcc-4e56-8330-8a0078599635`,
    title: 'Better Tea',
    description:
      'An Android app created using Kotlin in Android Studio to serve hot and breaking news from NY Times website right in your hands.',
    image: 'https://images.unsplash.com/photo-1467232004584-a241de8bcf5d',
    detail_description: `
# Better Tea
...
`,
    ...
    featured: false,
    skillId: [
      `c6663250-9ae0-4dc7-822a-070530945f89`,
      `2b64e489-4885-41c8-b82b-43e1f60b398e`,
      `eaf73bf2-a497-4a26-9c9a-796739cb8dd0`,
    ],
  },
  {
    id: `ee2f669c-166e-4732-bf45-322963e71cf4`,
    title: 'To-do App',
    description:
      'A mobile app created for the mobile platform Android with Java. Used to create tasks and list them, along with various options, such as notifying the user about the completion of the tasks.',
    image: 'https://images.unsplash.com/photo-1467232004584-a241de8bcf5d',
    detail_description: `
# To-do App
...
`,
  ...
  {
    id: `f0a0c61c-4def-4526-af73-baecbeec2231`,
    title: 'Pandemic Simulator',
    description:
      'A full-stack desktop GUI application that allows the user to input certain parameters, and then run a simulation to see how quickly a pandemic disease will spread through a population of a given size within a certain time.',
    image: 'https://images.unsplash.com/photo-1467232004584-a241de8bcf5d',
    detail_description: `
# Pandemic Simulator
...
`,
    // githubLink: 'https://github.com/project1',
    featured: false,
    skillId: [`ba70488d-925f-43d0-a003-ac7cfa449c2d`],
  },
  {
    id: `57abd7eb-f800-4c8e-ad88-740c94b71d0e`,
    title: 'Ticket System Database',
    description:
      'A full-stack ticket creation, management, tracking system built on MS Access and VBA using separate backend (database) and frontend (UI) files with remote connection and authentication enabled.',
    image: 'https://images.unsplash.com/photo-1467232004584-a241de8bcf5d',
    detail_description: `
...
`,
    ...
    skillId: [
      ...
      `35bd7e99-14d6-4af0-b89a-4cafee4c1318`,
    ],
  },
  {
    id: `b2d32fab-6d6f-4c64-9de7-35bf4cc2b26f`,
    title: 'Database Automation with PL/SQL',
    description:
      'A script written in SQL with a number of functions and stored procedures using PL/SQL to simplify the complexity of data management.',
    image: 'https://images.unsplash.com/photo-1467232004584-a241de8bcf5d',
    detail_description: `
...
`,
    ...
    featured: false,
    skillId: [
      `24d7e7f8-d159-4ffc-ac7b-74049cd65f69`,
      `35bd7e99-14d6-4af0-b89a-4cafee4c1318`,
    ],
  },
  {
    id: `e592d715-1e16-460e-82d7-25ed86cb54b1`,
    title: 'SimpleBot - A Discord Bot',
    description:
      'A bot made for the IM platform Discord with Python as its core language to assist the server members.',
    image: 'https://images.unsplash.com/photo-1467232004584-a241de8bcf5d',
    detail_description: `
...
`,
    ...
    featured: false,
    skillId: [
      `5a476bdd-a90d-43c8-8b4b-674b0dfdcb0b`,
      `d1b545b3-48ad-45e0-99c9-ebc4f7d9b973`,
    ],
  },
  {
    id: `be64f769-4e53-4889-ac84-81c187eadba5`,
    title: 'Ocean Swimmer',
    description:
      'A 2D side scrolling game created in Unity using C# as the fundamental programming language. The game is available free-to-play on the web at mosarah99.itch.io. ',
    image: 'https://images.unsplash.com/photo-1467232004584-a241de8bcf5d',
    detail_description: `
...
`,
    ...
    featured: false,
    skillId: [
      `7f775a92-63e3-4bf5-a5bc-31a1891306de`,
      `78b72b27-a65b-4a86-9ef5-13f081beefd1`,
    ],
  },
  {
    id: `4e8d0155-4b2b-4f70-83fc-64c4c6bfbeb1`,
    title: 'Khronos',
    description:
      'A C++ project converting dates between different calendars to a Julian Date Number, highlighting test-driven development based on UML class diagrams.',
    image: 'https://images.unsplash.com/photo-1467232004584-a241de8bcf5d',
    detail_description: `
...
`,
    // githubLink: 'https://github.com/project1',
    featured: false,
    skillId: [`6e47c1f3-d51f-44de-885a-9b46971877ad`],
  },
  {
    id: `393052bc-6c96-466f-a514-7ef0aff05f89`,
    title: "Hospital Patients' Management",
    description:
      'A C++ program simulating a hospital queue managing patients based on calculated priority using a priority queue and class modeling. ',
    image: 'https://images.unsplash.com/photo-1467232004584-a241de8bcf5d',
    detail_description: `
...
`,
  ...
  {
    id: `17a42d92-2872-4615-a543-7361d93080cf`,
    title: 'Worldwide Importers Data Mart',
    description:
      'A data warehouse built in MSSQL Server based on the Worldwide Importers database, simulating real-world handling of databases through various stages and techniques. ',
    image: 'https://images.unsplash.com/photo-1467232004584-a241de8bcf5d',
    detail_description: `
...
`,
  ...
  {
    id: `d56509ee-956d-44e5-954d-a8da07dcafc9`,
    title: 'Responsive Portfolio Website Template',
    description:
      'A templated website created with HTML5, CSS3, and JavaScript, provides a responsive website template to build a portfolio website. ',
    image: 'https://images.unsplash.com/photo-1467232004584-a241de8bcf5d',
    detail_description: `
...
`,
    ...
    featured: false,
    skillId: [
      `41061e52-b6d9-4039-b070-6f5887ab1334`,
      `39b90a9c-8da2-4262-8351-47a837721b35`,
      `0922cb9d-641a-4b0a-bc0a-3b6e298ef468`,
      `beb936e8-a966-48ae-9839-7b924c47bc83`,
    ],
  },
  {
    id: `bb77af2d-cd47-48f5-9fbb-3252cf5c7ae1`,
    title: 'Contacts',
    description:
      'A mobile app to store and manage contact information, call, send SMS, or email.',
    image: 'https://images.unsplash.com/photo-1467232004584-a241de8bcf5d',
    detail_description: `
# Contacts
...
`,
    ...
    featured: false,
    skillId: [
      `a9470417-9dc8-403b-8bb6-5a83817f54f9`,
      `fa192048-20ad-4975-ba34-afb13e15c06f`,
      `212c8ad5-903c-4b50-887c-037b0b6ea06a`,
    ],
  },
  {
    id: `ba8fc431-c7d6-46ab-9bba-e28fe17fd6b9`,
    title: 'Alarm My Android',
    description: 'An android app to manage the alarms on the phone. ',
    image: 'https://images.unsplash.com/photo-1467232004584-a241de8bcf5d',
    detail_description: `
# Alarm My Android
